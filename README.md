...
Binanceの取引手数料は0.05％, HitBTCの取引手数料は0.1％なので, 閾値の設定を1.001（0.1％に対応する）より小さいような値にすると, 手数料負けするようになってしまいます. 取引所の手数料より0.1％以上高い値を指定することをお勧めします.<br>

閾値を大きく設定すると裁定機会が減るかわりに取引あたりの利益率は高くなり, 閾値を小さく設定すると裁定のチャンスは増えるかわりに取引あたりの利益率は低いものになります.<br>
...
こんなエラーが出たよ, という報告や, その対策など投げていただけると嬉しく思います.<br><br>
...
### 質問と連絡先
質問やご意見, 改善案などがあれば, 上記ブログのコメント欄や, GitHubのissues, またメールアドレス algorisamurai[at]gmail.com ([at]は@に変えてください)までお気軽にご連絡ください.<br>
